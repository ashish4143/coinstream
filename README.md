...
<img src="https://img.shields.io/badge/-CodeRabbit-FF6B6B?style=for-the-badge&logo=coderabbit&logoColor=white" />
  ...
  <h3 align="center">CoinStream — Analytics Dashboard</h3>
...
```bash
git clone https://github.com/adrianhajdin/coinpulse.git coinstream
cd coinstream
```
